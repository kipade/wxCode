...
// Created:     04/01/98
// RCS-ID:      $Id: minimal.cpp 1156 2009-12-20 15:16:16Z frm $
             ...
             wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)	
{
    ...
    // FIXME: why doesn't wx size the dialog so that it looks ok automatically?
    //        as of wx trunk r62958 this somehow doesn't work!
    wxSize sz(GetSizer()->GetMinSize());
    SetSize(wxSize(sz.GetWidth()*2, sz.GetHeight()*1.1));
